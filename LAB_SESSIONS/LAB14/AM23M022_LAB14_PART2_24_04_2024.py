# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 00:26:46 2024

@author: mdine
"""

'''
Implement a neural network for m-samples, n-features 
as we discussed in class (both FP and BP) and for N layers in the hidden layer. 
Split the data (you can use the log. reg. data or any other one) and 
train your network with 70% of the data. Use 15% for validation  and 
test your network with the remaining 15% data. Report the evaluation metrics 
for varying number of layers in the network. Plot the training loss curves
'''
...
dataset = pd.read_csv(r"E:\AM23M022_SEM2\DATASCIENCE_THEORY_AND_PRACTICE\Datascience_Submissions\LAB14\Logistic_regression_ls.csv")

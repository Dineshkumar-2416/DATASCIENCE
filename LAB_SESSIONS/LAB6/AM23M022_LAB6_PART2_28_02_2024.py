# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 20:21:27 2024
...
my_car = Car()
my_car.get_car_details("BMW", "C2", 2020, "Petrol")
my_car.display_vehicle()
...
class Student:
    # Class variables
    school_name = "St.ANtony's Matriculation Higher Secondary School"
    total_students = 0
...
student1 = Student("Kavi", 14, 9, 'male', ["Math", "Science", "English"])
student2 = Student("Shubhangi", 14, 9, 'female', ["History", "Geography", "Art"])
...
output_file = "E:\AM23M022_SEM2\DATASCIENCE_THEORY_AND_PRACTICE\Datascience_Submissions\LAB6\df to csv.txt"
df.to_csv(output_file, index=False, header=False)

print(f"Sorted words have been copied to {output_file}.")

with open (r"E:\AM23M022_SEM2\DATASCIENCE_THEORY_AND_PRACTICE\Datascience_Submissions\LAB6\df to csv.txt") as p:
    contents= p.read()
    print(contents)
